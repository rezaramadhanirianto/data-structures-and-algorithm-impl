...
public class BinarySearchTreeTest {
    ...
    public void concurrentModificationErrorPreOrder() {
        ...
        Iterator<Integer> iter = bst.traverse(BinarySearchTree.TraversalOrder.PRE_ORDER);
    ...
    public void concurrentModificationErrorInOrderOrder() {
        ...
        Iterator<Integer> iter = bst.traverse(BinarySearchTree.TraversalOrder.IN_ORDER);
    ...
    public void concurrentModificationErrorPostOrder() {
        ...
        Iterator<Integer> iter = bst.traverse(BinarySearchTree.TraversalOrder.POST_ORDER);
    ...
    public void concurrentModificationErrorLevelOrder() {
        ...
        Iterator<Integer> iter = bst.traverse(BinarySearchTree.TraversalOrder.LEVEL_ORDER);
    ...
    public boolean validateTreeTraversal(BinarySearchTree.TraversalOrder trav_order, List<Integer> input) {
    ...
    public void testPreOrderTraversal() {
        ...
        for (int i = 0; i < LOOPS; i++) {
            ...
            assertThat(validateTreeTraversal(BinarySearchTree.TraversalOrder.PRE_ORDER, input)).isTrue();
        }
    }
    ...
    public void testInOrderTraversal() {
        ...
        for (int i = 0; i < LOOPS; i++) {
            List<Integer> input = genRandList(i);
            assertThat(validateTreeTraversal(BinarySearchTree.TraversalOrder.IN_ORDER, input)).isTrue();
        }
    }
    ...
    public void testPostOrderTraversal() {
        ...
        for (int i = 0; i < LOOPS; i++) {
            List<Integer> input = genRandList(i);
            assertThat(validateTreeTraversal(BinarySearchTree.TraversalOrder.POST_ORDER, input)).isTrue();
        }
    }
    ...
    public void testLevelOrderTraversal() {
        ...
        for (int i = 0; i < LOOPS; i++) {
            List<Integer> input = genRandList(i);
            assertThat(validateTreeTraversal(BinarySearchTree.TraversalOrder.LEVEL_ORDER, input)).isTrue();
        }
    }
}