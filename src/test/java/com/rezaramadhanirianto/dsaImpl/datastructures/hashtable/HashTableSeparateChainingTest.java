...
public class HashTableSeparateChainingTest {
    ...
    public void removeTestComplex1() {
        ...
        HashTableSeparateChaining<HashObject, Integer> map = new HashTableSeparateChaining<>(10);
    ...
    public void testRandomMapOperations() {
        ...
        for (int loop = 0; loop < LOOPS; loop++) {
            ...
            for (int i = 0; i < MAX_SIZE; i++) {
                ...
                assertThat(jmap.containsKey(key)).isEqualTo(map.contains(key));
                assertThat(jmap.size()).isEqualTo(map.size());
    ...
    public void test(){
        ...
        m = new HashTableSeparateChaining<>(3);
        m.get(155);
    }
